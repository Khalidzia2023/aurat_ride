...
class CityToCityIndex extends StatefulWidget {
  const CityToCityIndex({super.key});

  @override
  State<CityToCityIndex> createState() => _CityToCityIndexState();
}

class _CityToCityIndexState extends State<CityToCityIndex> {
      ...
      appBar: PreferredSize(preferredSize: Size(0, 60 ),
        child: Container(
          ...
          child: AppBar(
            ...
            title: Text('City to City Support', style: TextStyle(color: Colors.white),),
            centerTitle: true,
